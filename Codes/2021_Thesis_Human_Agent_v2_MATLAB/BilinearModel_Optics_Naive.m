...
%disp(cond(F_P));
    for t = 1:simulationLength
        ...
        dp(:,t) = P0 * pj(:,t) - 1; % total Hb
        dq(:,t) = base_hbr * qj(:,t) -  1; % dxy-Hb
    ...
    title('M1  Optical density change. Sin Parentesis');
    ...
    title('SMA Optical density changes. Sin Parentesis');
    legend({'Lambda 1','Lambda 2'},'Location','southwest');
    ylabel('Delta Optical Density'); 
    xlabel('Time (Seconds)');
    shg;
    ...
    title('M1 Heamoglobin Concentration. Sin Parentesis');
    ...
    title('SMA Heamoglobin Concentration. Sin Parentesis');
    legend({'HbT','HbR', 'HbO_2'},'Location','southwest');
    ylabel('Relative Heamoglobin Concentration [\mu M]'); 
    xlabel('Time (Seconds)');
    shg;
