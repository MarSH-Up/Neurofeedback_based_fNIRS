function [Y] = BilinearModel_Optics_Naive_v2(pj, qj, U, A)
%% Version V1
...
M1 = zeros(2, simulationLength);
SMA = zeros(2, simulationLength);
...
%disp(cond(F_P));
    for t = 1:simulationLength
        ...
        dhq_r1 = [dq(1,t);dq(2,t)]; %DH y DQ de M1
        dhq_r2 = [dh(1,t);dh(2,t)]; %DH y DQ de SMA
    ...
    legend({'HbR', 'HbO_2'},'Location','southwest');
