...
%% 
    ...
    fjin = exp([0;0]);
    fjout_s = nan(nRegions,simulationLength);
    fjout_s1 = nan(nRegions,simulationLength);
...
%     shg;
%     figure
%     plot(transpose(fjout_s), 'LineWidth', 4);
%     title('fjout');
%     shg;
%     figure
%     plot(transpose(Sj), 'LineWidth', 4);
%     title('sj');
%     shg;
%     figure
%     plot(transpose(Vj), 'LineWidth', 4);
%     title('Vj');
%     shg;
%     figure
%     plot(transpose(fjin), 'LineWidth', 4);
%     title('Fjin');
%     shg;
%     figure
%     plot(transpose(fjout_s1), 'LineWidth', 4);
%     title('Efp');
